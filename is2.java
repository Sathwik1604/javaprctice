...
public class is2 {
    ...
    public static void encryptContent(BigInteger publicKeyA, BigInteger publicKeyB, String content, String outputFilename) throws Exception {
        RSAPublicKeySpec publicKeySpec = new RSAPublicKeySpec(publicKeyA, publicKeyB);
    ...
    public static void decryptContent(BigInteger privateKeyA, BigInteger privateKeyB, String encryptedContentPath, String outputFilename) throws Exception {
        RSAPrivateKeySpec privateKeySpec = new RSAPrivateKeySpec(privateKeyA, privateKeyB);
        KeyFactory keyFactory = KeyFactory.getInstance("RSA");
    ...
    public static void main(String[] args) throws Exception {
        ...
        BigInteger publicKeyA = scanner.nextBigInteger();
        System.out.print("Enter public key B: ");
        BigInteger publicKeyB = scanner.nextBigInteger();
